           ...
           <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="nav navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a href="shop.php"><i class="fa fa-shopping-basket" > Shop</i></span></a>
                    </li>
                    

                    <li class="active dropdown nav-item navbar-right">
                      
                        <a class="fa" href="#">Login | Register</a>
                    </li>
                </ul>
            </div>
          </nav>
...
<div class="form-group">
  ...
  <select class="form-control" id="sel1">
    <option class="active">Any model</option>
    <option>1128</option>
    <option>C2126</option>
  </select>
</div>
...
<form style=" background-color: lightgrey;"  method="POST" action="loginProcess.php" role="form">
